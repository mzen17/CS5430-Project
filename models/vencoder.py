...
class Encoder(nn.Module):
    def __init__(self, class_count, latentdim):
        super().__init__()
        ...
        self.mean = nn.Linear(64, latentdim) # mean dist
        self.logvar = nn.Linear(64, latentdim) # <- it is supposed to output a log of the variance
